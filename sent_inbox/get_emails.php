<?php 
    ...
    function get_emails() {
        ...
        $query = "SELECT E.ID, DATE_FORMAT(E.Created, '%m/%d/%Y %h:%i %p') as Created, Email_Address as Sender, Subject FROM Email E join Login L on (E.SenderID = L.ID) ORDER BY E.ID DESC;";
