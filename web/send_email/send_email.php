<?php
    ...
    array_push($errorList, "Feature disabled for demo purposes.");
    ...
    function get_semester_id() {
        ...
        if ($stmt->errorCode() === '00000') {
            ...
            array_push($errorList, $pdo->errorInfo()[2] . ":: LINE 69");
            print_response($responseList, $errorList, 0);
            die();
        }
    }
    ...
    function getRecipients($curriculum, $class_standing) {
        ...
        // start query
        $query = "SELECT ID, FirstName, LastName, EmailAddress FROM Students WHERE SemesterID = (SELECT ID FROM Semester WHERE IsActive = 1);";
   ...
   /* function sendEmailOriginal($email_id, $sender_id, $sender_email, $recipients, $subject, $body) {
    ...
    function insert_into_email_table($sender_id, $subject, $body, $recipients) {
        ...
        $query = "insert into Email values(null, :semester_id, CURRENT_TIMESTAMP(), :sender_id, :subject, :body, 0, 0, :recipient_count);";
