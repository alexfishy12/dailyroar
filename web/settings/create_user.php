        ...
        <div class="nes-container with-title is-centered">
            <form name = "input" action="insert_user.php" method="post">
                <div class="nes-field is-inline">
                    ...
                    <input type="text" id="f_name" class="nes-input is-success" name="f_name" required>
                </div>
                <br>
                <div class="nes-field is-inline">
                    <label for="l_name"> Last Name: </label>
                    <input type="text" id="l_name" class="nes-input is-success" name="l_name" required>
                </div>
                <br>
                <hr>
               ...
               <div class="nes-field is-inline">
                    ...
                    <input type="email" id="email" class="nes-input is-success" name="email" required>
                </div>
                <br>
               <div class="nes-field is-inline">
